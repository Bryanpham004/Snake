...
public class GameMain extends JPanel{
	...
	static final int CANVAS_WIDTH = COLS * CELL_SIZE;
	...
	class ControlPanel extends JPanel {
		...
		private ImageIcon iconStart = new ImageIcon("images/start.png");
		private ImageIcon iconPause = new ImageIcon("images/pause.png");
		private ImageIcon iconSound = new ImageIcon("images/sound.png");
		private ImageIcon iconMuted = new ImageIcon("images/muted.png");
	...
	private void setupMenuBar() {
		...
		hubItem = new JMenuItem("New", KeyEvent.VK_N);
		hub.add(hubItem);
		...
		hubItem = new JMenuItem("About", KeyEvent.VK_A);
		hub.add(hubItem);
		hubItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(GameMain.this, 
						"The snake hunting is the recreation of the orginal game: SNAKE. The user's gaol is to grow longer from eating the food located in the game and not die by hitting the walls or itself.",
